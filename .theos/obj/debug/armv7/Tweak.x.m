...
@class YTVideoQualitySwitchControllerFactory; @class YTPivotBarView; @class YTVolumeBarView; @class UIApplication; @class YTVideoQualitySwitchOriginalController; 
...
#line 3 "Tweak.x"
static void (*_logos_orig$FckYTShortsandUpload$YTPivotBarView$setItemView2$)(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL, YTPivotBarItemView *); static void _logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView2$(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL, YTPivotBarItemView *); static void (*_logos_orig$FckYTShortsandUpload$YTPivotBarView$setItemView3$)(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL, YTPivotBarItemView *); static void _logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView3$(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL, YTPivotBarItemView *); static YTPivotBarItemView * (*_logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView2)(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL); static YTPivotBarItemView * _logos_method$FckYTShortsandUpload$YTPivotBarView$itemView2(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL); static YTPivotBarItemView * (*_logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView3)(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL); static YTPivotBarItemView * _logos_method$FckYTShortsandUpload$YTPivotBarView$itemView3(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST, SEL);  
    
    static void _logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView2$(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, YTPivotBarItemView * argument) {
        argument.navigationButton.hidden = YES;
    }

    static void _logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView3$(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, YTPivotBarItemView * argument) {
    argument.navigationButton.hidden = YES;
    }

    static YTPivotBarItemView * _logos_method$FckYTShortsandUpload$YTPivotBarView$itemView2(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
        YTPivotBarItemView *orig = _logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView2(self, _cmd);
        orig.navigationButton.hidden = YES;
        
        return nil;
    }

    static YTPivotBarItemView * _logos_method$FckYTShortsandUpload$YTPivotBarView$itemView3(_LOGOS_SELF_TYPE_NORMAL YTPivotBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
        YTPivotBarItemView *orig = _logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView3(self, _cmd);
        orig.navigationButton.hidden = YES;
...
static __attribute__((constructor)) void _logosLocalCtor_9a0ae2bb(int __unused argc, char __unused **argv, char __unused **envp) {
    {Class _logos_class$FckYTShortsandUpload$YTPivotBarView = objc_getClass("YTPivotBarView"); { MSHookMessageEx(_logos_class$FckYTShortsandUpload$YTPivotBarView, @selector(setItemView2:), (IMP)&_logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView2$, (IMP*)&_logos_orig$FckYTShortsandUpload$YTPivotBarView$setItemView2$);}{ MSHookMessageEx(_logos_class$FckYTShortsandUpload$YTPivotBarView, @selector(setItemView3:), (IMP)&_logos_method$FckYTShortsandUpload$YTPivotBarView$setItemView3$, (IMP*)&_logos_orig$FckYTShortsandUpload$YTPivotBarView$setItemView3$);}{ MSHookMessageEx(_logos_class$FckYTShortsandUpload$YTPivotBarView, @selector(itemView2), (IMP)&_logos_method$FckYTShortsandUpload$YTPivotBarView$itemView2, (IMP*)&_logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView2);}{ MSHookMessageEx(_logos_class$FckYTShortsandUpload$YTPivotBarView, @selector(itemView3), (IMP)&_logos_method$FckYTShortsandUpload$YTPivotBarView$itemView3, (IMP*)&_logos_orig$FckYTShortsandUpload$YTPivotBarView$itemView3);}}
