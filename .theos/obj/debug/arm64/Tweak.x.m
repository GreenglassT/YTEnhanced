...
@class YTIHamplayerSoftwareStreamFilter; @class UIApplication; @class YTIHamplayerStreamFilter; @class YTSettings; @class UIDevice; @class YTVideoQualitySwitchControllerFactory; @class YTVersionUtils; @class MLManualFormatSelectionMetadata; @class YTUserDefaults; @class NSProcessInfo; @class YTPivotBarView; @class YTBaseInnerTubeService; @class YTVolumeBarView; @class _ASDisplayView; @class YTVideoQualitySwitchOriginalController; 
